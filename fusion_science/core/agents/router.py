...
_ROUTE_KEYWORDS: dict[str, list[str]] = {
    "literature": [
        "search", "find", "retrieve", "paper", "literature", "pubmed",
        "review", "citation", "pico", "consensus", "synthesi",
    ],
    "data": [
        "analyze", "analysis", "compute", "calculate", "statistics",
        "python", "code", "execute", "run", "deseq", "correlation",
    ],
    "visualize": [
        "chart", "plot", "figure", "visual", "graph", "heatmap",
        "volcano", "molecule", "protein", "3d",
    ],
    "writer": [
        "write", "draft", "compose", "section", "introduction",
        "methods", "discussion", "conclusion", "cite",
    ],
}
